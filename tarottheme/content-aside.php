            ...
            <div class="mbr-box mbr-box--stretched"><div class="mbr-box__magnet mbr-box__magnet--center-left">
                <div class="row"><div class=" col-sm-6 col-sm-offset-6">
                    <div class="mbr-hero animated fadeInUp">
                        <h1 class="mbr-hero__text"><?php echo the_title(); ?>o</h1>
                        <p class="mbr-hero__subtext"><?php echo get_the_excerpt(); ?></p>
                    </div>
                    <div class="mbr-buttons btn-inverse mbr-buttons--left"><a class="mbr-buttons__btn btn btn-lg btn-warning animated fadeInUp delay" href="<?php the_permalink(); ?>">Reservar cita ya</a></div>
                </div></div>
            </div></div>
        </div>
